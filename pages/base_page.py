...
class BasePage:
    ...
    @allure.step('Поиск элемента и проверка доступности клика')
    ...
    @allure.step('Поиск элемента и проверка его видимости')
    ...
    @allure.step('Скроллим страницу до искомого элемента')
    ...
    @allure.step('Нажимаем на логотип "Яндекс" в header')
