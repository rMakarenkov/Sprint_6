...
class OrderPage(BasePage):
    ...
    @allure.step('Вводим станицию метро')
    ...
    @allure.step('Вводим ожидаему дату получения заказа')
    ...
    @allure.step('Нажимаем на кнопку "Заказать" на странице заказа с арендой')
